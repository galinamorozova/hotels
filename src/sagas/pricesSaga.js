...
function* pricesWorker() {
    ...
    const data = yield call(fetch, 'https://engine.hotellook.com/api/v2/cache.json:splat?',
        { method: 'GET',
            mode: 'cors',
            body: 'location=' + locationData + 'currency=rub' + 'checkIn=' + {checkInData} + 'checkOut=' + checkOutData,
            headers: {
