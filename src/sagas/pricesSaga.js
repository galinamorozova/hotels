...
function* pricesWorker() {
    ...
    const data = yield call(fetch, 'http://engine.hotellook.com/api/v2/cache.json?location=Moscow&currency=rub&checkIn=2023-12-10&checkOut=2023-12-12&limit=10', { method: 'GET', referer: 'https://main--startling-druid-b9d701.netlify.app/hotels'});
