...
function* pricesWorker() {
    ...
    const data = yield call(fetch, 'http://engine.hotellook.com/api/v2/cache.json?location=Moscow&currency=rub&checkIn=2020-12-10&checkOut=2020-12-12&limit=10', { method: 'GET', referer: 'https://main--startling-druid-b9d701.netlify.app/hotels'});
